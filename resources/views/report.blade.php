{{--@if(session()->get('access_key')=='allowed')--}}
    <!DOCTYPE html>
...
<head>
    ...
    <title>Chức năng nâng cao</title>
    <!-- Fonts -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="{{route('task.reset')}}" class="underline text-gray-900 dark:text-white">Reset
                                nhiệm vụ</a>
                        </div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Bộ quản lý thông tin nhân sự, thông tin khách hàng và định mức lao động áp dụng cho MTT và
                            TBHT được tạo bởi ngôn ngữ Laravel. <br>Made by Sweetsica!💕
                        </div>
                    </div>
                </div>
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{route('human.list')}}" class="underline text-gray-900 dark:text-white">Nhập
                                nhân sự từ Amis</a></div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{route('customerdms.list')}}" class="underline text-gray-900 dark:text-white">Nhập
                                data khách DMS</a></div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">Bán buôn
                            <form method="post" action="{{route('excel.import.dms.buon')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="file" name="file">
                                <button type="submit">Gửi</button>
                            </form>
                            Bán lẻ
                            <form method="post" action="{{route('excel.import.dms.le')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="file" name="file">
                                <button type="submit">Gửi</button>
                            </form>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a href="{{route('task.list')}}" class="underline text-gray-900 dark:text-white">Nhiệm
                                vụ</a></div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <form method="post" action="{{route('excel.import.task')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="file" name="file">
                                <button type="submit">Gửi</button>
                            </form>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                            <a href="{{route('task.list')}}" class="underline text-gray-900 dark:text-white">Đăng tải file</a>
                        </div>
                    </div>
                    ...
                    <div class="ml-12">
                        ...
                        <form action="{{route('report.upload')}}" class="col-md-5" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Modal body</p>
                                            <div id="file-uploader1" class="wrapper js">Nhập</div>
                                        </div>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    ...
                    <a href="https://zalo.me/0327350489" class="ml-1 underline">
                        Liên hệ zalo
                    </a>
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="ml-4 -mt-px w-5 h-5 text-gray-400">
                        <path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                    </svg>
                    <a href="barondeepsnow@gmail.com" class="ml-1 underline">
                        barondeepsnow@gmail.com
                    </a>
                </div>
            </div>
...
<script type="text/template" id="file-uploader-template">
    <form class="js--upload-form is-droppable">
        <span class="text--center">
            ...
            <span class="js--advanced-upload">Drop files to attach, or
                <label class="btn btn--link" for="file">browse</label>
            </span>
            <input type="file" name="files" id="file" class="js--basic-upload hide"
                   data-multiple-caption="{count} files selected" multiple="" accept=".pdf,.xlsx,.jpg,.jpeg,.png">
        </span>
